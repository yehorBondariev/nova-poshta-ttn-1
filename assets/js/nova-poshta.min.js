jQuery(document).ready(function () {
  ...
  if(sp1){
    ...
    //    jQuery("#billing_nova_poshta_city").selectize();
    //        jQuery("#billing_nova_poshta_warehouse").selectize();
              //jQuery("#billing_nova_poshta_region").selectize();
   ...
   language: {
    ...
    ajax: {
      ...
      data: function (params) {
                ...
                d: jQuery("#billing_nova_poshta_region").val(),
        				action: 'my_actionfogetnpshippngcities',
      				};
    			},
          ...
          processResults: function( data ) {
              ...
              console.log(data);
     					...
     					jQuery.each( data, function( index, text ) { // do not forget that "index" is just auto incremented value
     						options.push( { id: data[index].ref, value: data[index].ref, text: data[index].description  } );
     					});
